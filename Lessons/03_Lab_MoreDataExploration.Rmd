...
```{r}
high_temp<-c(52,55,54,49,53,56,53,42,36,34)
low_temp<-c (41,32,32,32,28,36,26,16,22,21)
```
...
```{r}
Durham_Forcast<- data.frame(high_temp,low_temp,CHigh,CLow)
names(Durham_Forcast)<-c("High_F","Low_F","High_C","Low_C")
```
